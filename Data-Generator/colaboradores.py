...
for _ in range(tuples):  # alterar lineas para las diversas columnas de la BD
    ...
    fake_data['nro_documento'].append(fake.md5()[0:9])
    ...
    fake_data['cuenta_colaborador'].append(fake.bban()[:20])
    fake_data['areatrabajo_id'].append(puestoTrabajo_t[random.randint(0, len(puestoTrabajo_t)-1)])
...
"""
    Espero no existan cuentas de banco repetidas entre personas distintas
"""